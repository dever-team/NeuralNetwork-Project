...
h1 = Dense(64, activation='relu', use_bias=True)(flatten)
h2 = Dense(64, activation='relu', use_bias=True)(h1)
output_layer = Dense(10, activation='softmax', use_bias=True)(h2)
